        ...
        {showFilters && (
          <View style={[styles.filters, { backgroundColor: Brand.surfaceDark, borderColor: Brand.borderSubtle }]}>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              ...
              >
                <Text style={[styles.filterChipText, { color: !selectedGenre ? "#fff" : Brand.textPrimary }]}>
                  Vsi
                </Text>
              </TouchableOpacity>
              {GENRES.map((genre) => (
                ...
                >
                  <Text
                    style={[
                      ...
                      { color: selectedGenre === genre ? "#fff" : Brand.textPrimary },
                    ]}
                  >
                    {genre}
                  </Text>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              ...
              >
                <Text style={[styles.filterChipText, { color: !selectedRegion ? "#fff" : Brand.textPrimary }]}>
                  Vse
                </Text>
              </TouchableOpacity>
              {SLOVENIAN_REGIONS.map((region) => (
                ...
                >
                  <Text
                    style={[
                      styles.filterChipText,
                      { color: selectedRegion === region ? "#fff" : Brand.textPrimary },
                    ]}
                  >
                    {region}
                  </Text>
